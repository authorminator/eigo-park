      ...
      <div className="flex justify-center gap-4 mt-4">
        <label className="flex items-center gap-2 text-sm text-gray-700">
          <input
            ...
            onChange={() => {
              const updated = !showFirstLetter;
              setShowFirstLetter(updated);
              const revealed = getRevealedLetters(word, updated);
              setGuessed(revealed);
            }}
          />
...
//   const getRevealedLetters = (word, showFirst) => {
//     if (!showFirst || !word) return [];
//     const revealed = [];

//     // Reveal ONLY the first letter (even if it repeats later)
